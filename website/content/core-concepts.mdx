...
A way out from a book totally unrelated to the web: [_The Visual Display of Quantitative Information_](https://www.edwardtufte.com/tufte/books_vdqi) by Edward Tufte, first published in 1975. Tufte describes the parts of a graph that do not contain information "non-data ink". For example, the two charts below both show the same data:
