...
import { CoreConceptsDemoContainer } from '../../sandbox/HomepageDemoContainer';
...
[Read more about primatives.](./composing-charts/3-primatives)

## HTML layer

Tooltips are a very common pattern in web charts. Hypocube allows rendering of HTML elements at positions defined on the Cartesian scale.
