...
<PropDef name="tickPositions" type="Contextual<number[]>" def="[]">
  An array of numbers indicating tick positions. It may be{' '}
  <a href="./2-chart-styles#contextualchartstyles">
    contextual and respond to chart size
  </a>
  .
</PropDef>
...
<PropDef name="chartStyle">
  ...
  <a href="./2-chart-style/#axisstyles">chart style</a>.
</PropDef>
<PropDef
  name="renderTickMark"
  type="({ position: Point, label?: string, chartStyle }) => React.Element"
>
  Render prop for tick marks (both the line marker and label). See the{' '}
  <a href="../composing-charts/2-tick-marks">TickMark component docs</a> for
  more information.
</PropDef>
