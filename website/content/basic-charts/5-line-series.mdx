...
<PropDef name="chartStyle">
  ...
  <a href="./2-chart-style#databoxes">chart style</a>. Usually, the databox
  styles are used with this type of data series.
</PropDef>
...
<PropDef name="renderLine" type="React.Component<{ data; chartStyle }>">
  ...
  more information. By default it renders a `DataLine` and a replacement
...
>
  Render prop for the line connecting the data points. See the{' '}
  <a href="../composing-charts/1-data-components">data component docs</a> for
  more information. By default it renders a `DataPoint` and a replacement
  component should accept the same props.
</PropDef>
