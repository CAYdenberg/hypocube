...
See also the [dataPoint chart style](/basic-charts/2-chart-style#datapoints) chart styles.

### DataAnchorLine

This is a variant of DataPoint that renders a horizontal line at the point, instead of a symbol. See also the [dataAnchor style](/basic-charts/2-chart-style#dataranges).
...
See also the [dataBox styles](/basic-charts/2-chart-style#databoxes).
...
This is a variant of `DataBoxVertical` that renders a whisker ("error bar") instead of a rectangle. See the [dataRange](/basic-charts/2-chart-style#datarange) styles.
